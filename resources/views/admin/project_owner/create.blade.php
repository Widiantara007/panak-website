...
<div class="row">
    <div class="col-12">
        <div class="card shadow mb-4">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('project-owner.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="name">Nama</label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="ex: Burhan Alinurdin" value="{{old('name') }}">
                        </div>
                    </div>
                    <div class="row mt-3">
