...
<div class="row">
    <div class="col-12">
        <div class="card shadow mb-4">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('edunak-article.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-3">
                        <div class="form-group col-md-6">
                            ...
                            placeholder="ex: Cara Budidaya Ikan Air Laut" value="{{old('title') }}" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="form-group col-md-3">
                            <label for="cover_image">Gambar Cover</label>
                            <input type="file" class="form-control" name="cover_image" id="cover_image" accept="image/*" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-check form-check-inline">
                          ...
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_published" id="is_published2" value="1" {{old('is_published') ? 'checked':''}}>
