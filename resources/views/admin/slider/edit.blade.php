...
<h1 class="h3 mb-0 text-gray-800">Edit Slider Landing</h1>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="title" id="title"
                                placeholder="ex: Investasi Mulai RP 50.000" value="{{old('title') ?? $slider->title }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="name">Description</label>
                            <input type="text" class="form-control" name="description" id="description"
                                placeholder="ex: Investasi membantu peternak ..." value="{{old('description') ?? $slider->description }}">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="file" class="form-control" name="image" id="image"
                                    accept="image/png,image/jpeg,image/jpg" value="{{old('image') ?? $slider->image }}">
                            </div>
                        </div>
                    </div>
