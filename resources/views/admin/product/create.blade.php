                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="ex: Lele Bumbu Kuning" value="{{old('name') }}" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" name="stock" id="stock"
                                placeholder="Masukan stock barang" value="{{old('stock') }}" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="name">Discount</label>
                            <div class="input-group">
                                <input type="number" class="form-control" name="discount" id="discount"
                                    placeholder="Max 100" max="100" value="{{old('discount') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="weight" id="weight"
                                    placeholder="ex: 100"  value="{{old('weight') }}" required>
